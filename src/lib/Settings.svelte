<script lang="ts">
  ...
  let showModal = false;
  let localSettings = $clockSettings;

  function toggleModal() {
    showModal = !showModal;
    // Reset local settings when opening modal
    if (showModal) {
      localSettings = { ...$clockSettings };
    }
  }

  function saveSettings() {
    clockSettings.set(localSettings);
    showModal = false;
  }
</script>
...
{#if showModal}
  <div class="modal modal-open">
    <div class="modal-box">
      <h3 class="font-bold text-lg mb-4">Clock Settings</h3>
      ...
      <div class="form-control">
        <label class="label cursor-pointer">
          ...
          <input
            type="checkbox"
            class="toggle"
            bind:checked={localSettings.use24Hour}
          />
        </label>
      </div>
      ...
      <div class="form-control">
        <label class="label cursor-pointer">
          ...
          <input
            type="checkbox"
            class="toggle"
            bind:checked={localSettings.showSeconds}
          />
        </label>
      </div>
      ...
      <div class="form-control">
        ...
        <select
          ...
          bind:value={localSettings.dateFormat}
        >
